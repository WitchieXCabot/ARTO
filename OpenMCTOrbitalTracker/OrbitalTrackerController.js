define([], function() {
    function orbitalTrackerContoller(data, orbitaltrackerModel, orbitaltrackerRenderer, domainObject, openmct){
        this.data = data;
    ...
    orbitalTrackerContoller.prototype.bounds = function(bounds, wasTick){
        if(!wasTick){
            this.refresh();
        }
    };

    orbitalTrackerContoller.prototype.refresh = function(){
    ...
    orbitalTrackerContoller.prototype.datum = function(property, datum){
        if(this.requesting){
    ...
    orbitalTrackerContoller.prototype.handleResponses = function(responses){
        ...
        while(index.counts < responses.counts.length){
            ...
            if(index.y < responses.y.length && responses.y[index.y][keys.y] < countsDomainValue){
                index.y += 1;
            }
    ...
    orbitalTrackerContoller.prototype.flush = function(){
    ...
    orbitalTrackerContoller.prototype.scheduleRendering = function(){
    ...
    orbitalTrackerContoller.prototype.updateView = function(){
        var xTicks = [];
        var yTicks = [];
    ...
    orbitalTrackerContoller.prototype.destroy = function(){
    ...
    return orbitalTrackerContoller;
});